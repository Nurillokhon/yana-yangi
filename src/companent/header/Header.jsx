    ...
    return (
      <>
        <div>
          ...
          >
            <h3 className="fw-bold " onClick={() => hamma()}>
              Hot arrivals
            </h3>
            <div className="d-flex">
              ...
              <a className="hots" href="#card">
                {" "}
                <h6 className="px-4" onClick={() => Self()}>
                  Self-development
                </h6>
              </a>
              <a className="hots" href="#card">
                {" "}
                <h6 className="px-4 hover1" onClick={() => Det()}>
                  Detectives
                </h6>
              </a>
              <h6 className="px-4 hots">Baby</h6>
              <h6 className="px-4 hots">Audiobooks</h6>
              <a className="hots" href="#card">
                <h6 className="px-4 hover1" onClick={() => boshqa()}>
                  Other
                </h6>
              </a>
            </div>
